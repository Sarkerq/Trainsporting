...
namespace Trainsporting.Classes
{
    public class Scene
    {
        ...
        {
            Volume rockModel = Volume.VolumeFactory("rock.obj", "rock.png", "rock",
        ...
        static void setupTrees()
        {
            for (int i = 0; i < 100; i++)
            {
                Volume treeModel = Volume.VolumeFactory("tree.obj", "tree.png", "tree",
        ...
        static void setupTrainAndTracks()
        {
            ...
            Volume trackModel = Volume.VolumeFactory("track.obj", "basic2.png", "TrackMetal",
